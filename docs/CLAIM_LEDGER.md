...
| `db/ledger/0002_claim_metric_value_text_nullable.sql` | Forward migration: relaxes `claim_metric.value_text NOT NULL` so an unknown value persists as NULL (#25) |
