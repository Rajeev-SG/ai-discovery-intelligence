...
Senior media, marketing, search and digital leaders — not SEO technicians.

## Weekly brief

Default target: **0–3 items**, hard maximum 5.

Each item contains:

- **Change:** one sentence.
- **Why it matters:** one or two sentences tied to consumer discovery/commercial impact.
- **Agency action:** one concise recommendation or “monitor only”.
- **Confidence:** label plus short rationale.
- **Evidence:** links/IDs, hidden behind expansion in UI where possible.

## Include

- material shifts in platform audience/usage that change prioritization;
- retrieval/index/search architecture changes;
- large source/citation ecosystem shifts;
- shopping, transaction or ad-surface changes;
- crawler/index policy changes that alter brand visibility;
- material referral/conversion/measurement findings;
- a regionally dominant surface becoming commercially material.

## Exclude by default

- model benchmark scores;
- developer/API features without consumer discovery impact;
- tiny UI tweaks;
- generic “10 GEO tips” content;
- vendor self-promotion without meaningful evidence;
- tactical changes that do not affect senior strategy;
- repeated stories that do not change the existing POV.

## Living POV structure

1. Executive position: how AI discovery fits alongside conventional search.
2. Channel/surface prioritization by geography/category.
3. How retrieval/search/citation systems differ.
4. What brands should optimize: owned content, indexability, structured/product data, authority, third-party sources, UGC, feeds and measurement.
5. Measurement principles and known blind spots.
...
Supporting evidence: 0b187a5b6f942c1d2a3fcb12285238e5
