...
class ChangeEvent(BaseModel):
    ...
    claims: list[str] = Field(default_factory=list, description="Claim IDs this event is grounded in")
    ...
    supersedes: str | None = Field(default=None, description="Event ID this event updates/qualifies")
    source_hash: str | None = Field(default=None, description="sha256 of the capture text")
    dedupe_key: str | None = Field(default=None, description="Stable key for syndicated/duplicate coverage")
