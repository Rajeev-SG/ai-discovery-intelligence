...
SIM = {
    ...
    "metrics": [
        ...
        },
        {
            ...
            "comparator": "share_of_total",
            "window": {"value": "~Apr 2025 (12 months before measurement)", "quote": "12 months ago"},
            "scope": {"value": "worldwide, all AI chatbots", "quote": "all AI chatbot web traffic"},
        },
        {
            ...
            "value": {"value": 27.3, "quote": "rising from roughly 9% to 27.3% over the same period"},
...
SIS = {
    ...
    "methodology": {
        ...
        "unit_of_analysis": {"value": "cited source/domain per weekly prompt set", "quote": "sources in AI-generated responses"},
        "time_window": {"value": "17 weeks (study period, published May 2026)", "quote": "over 17 weeks"},
        "geography": {
        ...
        "language": {"value": "English-language report", "kind": "jsonld_field",
    ...
    "metrics": [
        {
            ...
            "definition": {"value": "% of ChatGPT sources replaced each week", "quote": "ChatGPT replaces as much as 74%"},
            "value": {"value": "74%", "quote": "ChatGPT replaces as much as 74%"},
            "unit": {"value": "%", "quote": "74%"},
            "comparator": "exact",
            "window": {"value": "per week over 17 weeks", "quote": "every week"},
            "scope": {"value": "ChatGPT, six countries", "quote": "ChatGPT replaces as much as 74%"},
        },
        {
            "metric_id": "google_ai_mode_weekly_churn",
            "label": "Google AI Mode weekly source churn",
            "definition": {"value": "% of Google AI Mode sources replaced each week", "quote": "Google replaces 56% of sources"},
            "value": {"value": "56%", "quote": "Google replaces 56% of sources in AI-generated responses every week"},
            "unit": {"value": "%", "quote": "56%"},
            "comparator": "exact",
            "window": {"value": "per week over 17 weeks", "quote": "every week"},
            "scope": {"value": "Google AI Mode, six countries", "quote": "Google replaces 56% of sources"},
        },
        {
            "metric_id": "google_ai_mode_country_range",
            "label": "Google AI Mode weekly churn range across countries",
            "definition": {"value": "country-level weekly churn range", "quote": "drift rates in Google AI Mode are remarkably consistent across all six countries studied"},
            "value": {"value": "54-59%", "quote": "Drift rates remain consistently at 54-59% across six countries"},
            "unit": {"value": "%", "quote": "54-59%"},
            "comparator": "exact",
            "window": {"value": "weekly, 17 weeks", "quote": "over the 17-week period"},
            "scope": {"value": "Google AI Mode, six countries incl. US and Germany", "quote": "not a phenomenon specific to the US or Germany"},
        },
    ],
    "dates": {
    ...
    "capture_anchors": [
        {"kind": "jsonld_field", "selector": "datePublished=2026-05-01T11:34:47+00:00 / dateModified=2026-05-12T12:41:18+00:00"},
        {"kind": "verbatim_quote", "quote": "Google replaces 56% of sources in AI-generated responses every week, whilst ChatGPT replaces as much as 74%"},
    ],
    "extraction": {"method": "deterministic_parser", "tool": "ai_discovery.claims",
...
YAN = {
    ...
    "methodology": {
        ...
        "time_window": {"value": "each month (no named measurement month; published Sep 2026)", "quote": "each month"},
        "geography": {"value": "Russia / Russian-language Yandex ecosystem", "quote": "blind tests of Russian-language answer quality"},
        "geography_basis": "source_stated",
    ...
    "metrics": [
        {
            ...
            "definition": {"value": "people using AI answers in Yandex Search per month", "quote": "use the feature each month"},
            "value": {"value": 49000000, "quote": "More than 49 million people use the feature each month"},
            "unit": {"value": "people (monthly)", "quote": "49 million people"},
            "comparator": "at_least",
            "window": {"value": "each month (unnamed)", "quote": "each month"},
            "scope": {"value": "Yandex Search AI answers feature", "quote": "the feature each month"},
        },
    ],
    "dates": {
        ...
        "measured_window": {"value": "each month (no named measurement month)", "quote": "each month"},
        "observed_at": "2026-09-16T12:10:00+00:00",
    },
    "capture_anchors": [
        {"kind": "page_stamp", "selector": "September 14, 2026"},
        {"kind": "verbatim_quote", "quote": "More than 49 million people use the feature each month, making it Yandex's most widely used generative AI product"},
    ],
    "extraction": {"method": "deterministic_parser", "tool": "ai_discovery.claims",
...
NAV = {
    ...
    "methodology": {
        "measurement_mode": "press_release",
        "metric_family": {"value": "cumulative users and card click-through rate", "quote": "Surpassed 4 million cumulative users"},
        "metric_definition": {
        ...
        "time_window": {"value": "~2 months post-Apr 2026 beta, to 26 Jun 2026 launch", "quote": "in about two months"},
        "geography": {
        ...
        "language": {"value": "Korean", "kind": "jsonld_field",
                      "selector": "document element lang=ko"},
        "language_basis": "source_stated",
        "devices": {"value": "mobile and PC search bars", "quote": "one click from the mobile and PC search bars"},
        "limitations": [
    ...
    "metrics": [
        {
            ...
            "definition": {"value": "cumulative users in ~2 months of beta", "quote": "Surpassed 4 million cumulative users in two months after beta launch"},
            "value": {"value": 4000000, "quote": "surpassed 4 million cumulative users in about two months"},
            ...
            "scope": {"value": "NAVER Plus Membership beta users", "quote": "for NAVER Plus Membership users"},
        },
        {
            "metric_id": "card_ctr",
            "label": "Product/place card click-through rate",
            "definition": {"value": "CTR for product and place cards during beta", "quote": "click-through rates (CTR) for both product and place cards"},
            "value": {"value": ">20%", "quote": "click-through rates (CTR) for both product and place cards exceeded 20%"},
            "unit": {"value": "%", "quote": "20%"},
            "comparator": "at_least",
        ...
        },
        {
            ...
            "definition": {"value": "average daily visitors to NAVER's main page (not AI Tab users)", "quote": "which receives an average of 50 million daily visitors"},
            "value": {"value": 50000000, "quote": "which receives an average of 50 million daily visitors"},
            "unit": {"value": "visitors per day", "quote": "daily visitors"},
            "comparator": "approx",
            "window": {"value": "period not stated", "quote": "receives an average of"},
            "scope": {"value": "NAVER main page / service environment", "quote": "NAVER's service environment, which receives an average of 50 million daily visitors"},
        },
    ],
    "dates": {
        ...
        "modified_at": None,
        "modified_at_selector": None,
        "measured_window": {"value": "Apr-Jun 2026 (~2-month beta)", "quote": "in about two months"},
        "observed_at": "2026-09-16T12:15:00+00:00",
    },
    "capture_anchors": [
        {"kind": "page_stamp", "selector": "2026.06.26"},
        {"kind": "verbatim_quote", "quote": "surpassed 4 million cumulative users in about two months"},
    ],
    "extraction": {"method": "deterministic_parser", "tool": "ai_discovery.claims",
