...
required = [
    "README.md", "AGENTS.md", "docs/AGENT_BOOTSTRAP.md", "docs/OSS_STACK.md",
    "docs/ACCEPTANCE_STANDARD.md", "config/surfaces.yaml", "config/sources.yaml",
    "config/executive_policy.yaml", "config/significance.yaml",
]
